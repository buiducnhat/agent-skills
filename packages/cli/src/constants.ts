export const REPO_URL = "https://github.com/buiducnhat/cobrew.git";
...
export const RULES_MARKER_START = "<!-- BEGIN cobrew rules -->";
export const RULES_MARKER_END = "<!-- END cobrew rules -->";
