...
| ------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Codex plugin install                  | Use CoBrew workflows in Codex without running the CLI installer                         | Run `codex plugin marketplace add buiducnhat/cobrew`, then install or enable the `cobrew` plugin from that marketplace |
| Claude Code plugin install            | Use CoBrew workflows in Claude Code without running the CLI installer                   | Run `claude plugin marketplace add buiducnhat/cobrew` or `/plugin marketplace add buiducnhat/cobrew`, then install or enable `cobrew` |
